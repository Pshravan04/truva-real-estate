...
export const properties: Property[] = [
        ...
        propertyReviews: [
            {
                userName: "Ramesh K.",
                rating: 5,
                comment: "Perfect location near Juhu beach. The balcony view is peaceful.",
                date: "1 week ago"
            }
        ],
        environmentalScores: { light: 9, noise: 8, air: 8 },
    ...
    },
    {
        ...
        facing: "West",
        floorDetail: "18/24",
        petAllowed: "Small Only",
        gatedSecurity: "Yes",
        preferredTenant: "Working Professionals",
        parking: "Car only",
        balcony: "2",
        postedOn: "Apr 12, 2026",
        featureRatings: {
            connectivity: 4.8,
            neighbourhood: 4.0,
            safety: 4.5,
    ...
    },
    {
        ...
        nonVegAllowed: "Yes",
        facing: "East",
        floorDetail: "Ground / Duplex",
        petAllowed: "Yes",
        gatedSecurity: "Yes Plus",
        preferredTenant: "High-Profile",
        parking: "4 Reserved",
        balcony: "3",
        postedOn: "Apr 15, 2026",
        featureRatings: {
            connectivity: 4.2,
            neighbourhood: 4.9,
            safety: 4.8,
